...
def select_top_features(X_train, y_train, n_features=50, random_state=42):
    """
    ...
    if len(y_train.shape) == 1 or y_train.shape[1] == 1:
        ...
        # 다중 타겟인 경우 평균 중요도 사용
        rf = MultiOutputRegressor(RandomForestRegressor(n_estimators=100, random_state=random_state, n_jobs=-1))
